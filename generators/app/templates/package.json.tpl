{
  ...
  "scripts": {
    "test": "gulp",
    "postinstall": "npm run symlinkApp",
    "pretest": "npm run symlinkApp",
    "prerun": "npm run symlinkApp",
    "symlinkApp": "./scripts/npm/app-symlink.sh",
    "develop": "gulp develop",
    "postinstall": "./scripts/npm/postinstall.sh",
    "start": "node index"
  },
  "contributors": [ "<%= authorName %> <<%= authorEmail %>>" ],
  "keywords": [<%= (keywords || []).map(function(kw) {return '"' + kw + '"'}) %>],
  "devDependencies": {
    "babel-eslint": "^3.1.23",
